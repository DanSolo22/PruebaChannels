"""
Django settings for PruebaChannels project.
...
SECRET_KEY = 'django-insecure-c6f@3g_^)@lv!r=6y4h-7(mqj2bp*1t()99xnzpip^3t7qy&%s'
...
ASGI_APPLICATION = 'PruebaChannels.asgi.application'
...
ROOT_URLCONF = 'PruebaChannels.urls'
